...
class Lap_kas_pinjaman_anggota extends OPPController {
	...
	public function index() {
		...
		$this->data['judul_sub'] = 'Data Pinjamanan Anggota';
		...
		$config = array();
		$config["base_url"] = base_url() . "lap_kas_pinjaman_anggota/index/halaman";
		...
		$this->data['isi'] = $this->load->view('lap_kas_pinjaman_anggota', $this->data, TRUE);
	...
	function cetak_laporan() {
     ...
     $html .= '
         ...
         '.$pdf->nsi_box($text = '<span class="txt_judul">Laporan Data Pinjaman Anggota <br></span>', $width = '100%', $spacing = '0', $padding = '1', $border = '0', $align = 'center').'
	...
	function export_excel(){
		...
		header("Content-Disposition: attachment; filename=pinjaman_anggota-".date("Y-m-d_H:i:s").".xls");
