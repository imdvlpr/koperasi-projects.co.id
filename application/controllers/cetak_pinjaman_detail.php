	...
	function cetak($id) {
		...
		<table width="100%" cellspacing="0" cellpadding="3" border="1" border-collapse= "collapse">';
			...
			<tr>
				...
				<td> Biaya Provisi </td>
				<td> : Rp. </td>
				<td class="h_kanan"> '.number_format($row->provisi_pinjaman).'</td>
			</tr>
			<tr>
				<td > Nomor Pinjam </td>
				<td > :  </td>
		...
		$html .= '<table width="100%">
			<tr class="header_kolom">
				...
				<th style="width:10%;"> Biaya Provisi</th>
		...
		if(!empty($simulasi_tagihan)) {
			...
			$html .= '<tr bgcolor="#eee">
						...
						<td class="h_kanan"><strong>'.number_format(nsi_round($jml_provisi)).'</strong></td>
