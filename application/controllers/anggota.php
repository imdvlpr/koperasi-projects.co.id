...
class Anggota extends OperatorController {
	...
	public function index() {
		...
		$crud->columns('file_pic','no_anggota','identitas','nama','jk','alamat','kota','jabatan_id','departement','tgl_daftar','aktif','category');
		$crud->fields('no_anggota','nama','identitas','jk', 'tmp_lahir','tgl_lahir','status','departement','pekerjaan','agama','alamat','alamat_domisili','kota','notelp','tgl_daftar', 'jabatan_id','pass_word','status_anggota','aktif','code','file_pic','category');
		...
		$crud->required_fields('nama','identitas','tmp_lahir','tgl_lahir','jk','alamat','kota','jabatan_id','tgl_daftar','aktif','category');
