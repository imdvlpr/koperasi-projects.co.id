				...
				<td>
					<table style="width:100%">
						...
						<tr>
							...
							<td> : </td>
							<td class="h_kanan"> <?php echo number_format(($row_pinjam->biaya_adm) + ($row_pinjam->bunga_pinjaman)+ ($row_pinjam->provisi_pinjaman)); ?></td>
						</tr>
						<tr>
...
<table  class="table table-bordered">
	<tr class="header_kolom">
		...
		<th style="width:15%; vertical-align: middle"> Biaya Provisi</th>
...
if(!empty($simulasi_tagihan)) {
	...
	foreach ($simulasi_tagihan as $row) {
		...
		$provisi_pinjaman += $row['provisi_pinjaman'];
		...
		echo '
			<tr bgcolor='.$warna.'>
				...
				<td class="h_kanan">'.number_format(nsi_round($row['provisi_pinjaman'])).'</td>
	...
	echo '<tr bgcolor="#eee">
				...
				<td class="h_kanan"><strong>'.number_format(nsi_round($provisi_pinjaman)).'</strong></td>
