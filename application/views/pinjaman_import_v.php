...
if(isset($header)) {
	...
	echo '
		...
		';
	//$hidden = $values;
	echo form_open('pinjaman/import_db', '', array('val_arr' => $hidden_arr));
...
<?php if($form_view) { ?>
	...
	<input type="file" name="import_pinjaman" size="20" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" />
	<br /><br />
