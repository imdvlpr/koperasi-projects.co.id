		...
		<table>
			...
			<tr>
				<td colspan="2">
					...
					<a href="<?=base_url()?>lap_kas_simpanan_anggota/export_excel" class="easyui-linkbutton" iconCls="icon-excel" plain="false">Ekspor</a>
				</td>
			</tr>
		</table>
		</form>
...
function clearSearch(){
	window.location.href = '<?php echo site_url("lap_kas_simpanan_anggota"); ?>';
}
...
function cetak () {
	...
	?>
	var win = window.open('<?php echo site_url("lap_kas_simpanan_anggota/cetak_laporan/?jenis_anggota_id=' + jenis_anggota_id +'&anggota_id=' + anggota_id +'"); ?>');
	if (win) {
		win.focus();
	} else {
