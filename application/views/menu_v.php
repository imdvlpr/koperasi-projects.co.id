...
<li  class="treeview <?php 
	...
	<a href="#">
		<img height="20" src="<?php echo base_url().'assets/theme_admin/img/card.png'; ?>">
		<span>Autodebet</span>
		<i class="fa fa-angle-left pull-right"></i>
	</a>
	<ul class="treeview-menu">
		<li class="<?php if ($this->uri->segment(1) == 'setting_autodebet') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>setting_autodebet"> <i class="fa fa-folder-open-o"></i> Setting</a></li>
		<li class="<?php if ($this->uri->segment(1) == 'proses_autodebet') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>proses_autodebet"> <i class="fa fa-folder-open-o"></i> Proses</a></li>
	</ul>
</li>
<?php } ?>
