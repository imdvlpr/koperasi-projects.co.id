...
if(isset($header)) {
	...
	echo '
			<div class="alert alert-info">
				...
				Pastikan data sesuai dengan yang akan diimport, hindari duplikat data, cek kembali pada jenis kas, apakah data diatas memang belum ada di database.<br>
...
<?php if($form_view) { ?>
	...
	<input type="file" name="import_data_barang" size="20" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" />
	<br /><br />
